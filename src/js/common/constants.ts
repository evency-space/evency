...
export const SERVER_URL = process.env.REACT_APP_IS_DEV_SERVER
  ? "https://tracking-organizer-dev-99e72366a490.herokuapp.com"
  : "https://tracking-organizer.herokuapp.com";
